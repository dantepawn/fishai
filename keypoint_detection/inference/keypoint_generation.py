...
Usage:
    python keypoint_detection/inference/keypoint_generation.py --input_folder <path> --output_folder <path> --model_path <path>
"""
...
from fishai.keypoints.yolo_utils import generate_labels
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python keypoint_detection/inference/keypoint_generation.py --input_folder ./images --output_folder ./output --model_path ./best.pt
  python keypoint_detection/inference/keypoint_generation.py -i ./images -o ./output -m ./best.pt --confidence 0.3 --batch_size 16
  python keypoint_detection/inference/keypoint_generation.py -i ./images -o ./output -m ./best.pt --filter_lenses
        """
    )
